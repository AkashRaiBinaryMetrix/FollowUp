...

{
    ...
    public function index() {
        ...
        $propertyDetails = DB::table('property_list')->get();
        $AnnDetails = DB::table('agent_announcement')->get();
        $addlistingDetails = DB::table('create_add')->get();
        $aLists = DB::table('testimonial')->orderBy('id','desc')->get();
        $propertyDetailsFeatured = DB::table('property_list')->where('is_featured','=','Yes')->get();

        return view('myuser.home.index', ['propertyDetails'=>$propertyDetails, 'addlistingDetails'=>$addlistingDetails,'AnnDetails'=>$AnnDetails,'aLists' => $aLists,'propertyDetailsFeatured' => $propertyDetailsFeatured]);
    }
