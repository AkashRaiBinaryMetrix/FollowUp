...
(function($) {
    $.fn.WimmViewer = function (options) {
        ...
        options.miniatureSpace = options.miniatureSpace || 8;
        options.nextText = options.nextText || '<span class="las la-arrow-right"></span>';
        options.prevText = options.prevText || '<span class="las la-arrow-left"></span>';
