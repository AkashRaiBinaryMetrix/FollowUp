      ...
      <div class="row">
        ...
        <div class="col-md-4">
         <div class="mainmenu-links">
          ...
          <p><a href="#">Cap-Haitien, Nord</a></p>
          <p><a href="#">Petion-Ville, Ouest</a></p>
          <p><a href="#">Jacmel, Sud</a></p>
          <p><a href="#">Fort-Liberté, Nord-Est</a></p>
          <p><a href="#">Santiago de Los Caballeros</a></p>
          <p><a href="#">Santo-Domingo</a></p>     
         </div>  
        </div>  
...
<div class="inner-banner">    
 ...
 <div class="banner-vector"><img src="{{ asset('images/banner-vector.jpg') }}" alt=""></div>

 <div class="banner-left-vector"><img src="{{ asset('images/banner-left-vector.jpg') }}" alt=""></div>
 ...
 <div class="banner-search-col">
    ...
    <div class="banner-search">
     ...
     <form class="banner-search-form" name="cform" method="post" action="{{ route('search.query') }}">    

       @csrf
        
       <div class="search-inputbtns">

       <div class="form-check">

          <label class="form-check-label">

            <input type="radio" class="form-check-input" name="optradio" value="sell" checked>Buy
        ...
        <div class="form-check">
          ...
          <label class="form-check-label">
            ...
            <input type="radio" class="form-check-input" name="optradio" value="rent">Rent
       ...
       <div class="banner-inputsearch">
        <input type="text" class="form-control" name="search_query" placeholder="City, Neighborhood, Address" required>
      </div>  

       <div class="banner-searchbtn">
        <button type="submit" name="btnSubmitSearch"><img src="{{ asset('images/big-search-ico.png') }}" alt=""></button>
       </div>
    ...
    <p>
      ...
      <a href="{{url('search_city_property/61')}}">Cap-Haitien</a>, 
      <a href="{{url('search_city_property/67')}}">Cayes</a>, 
      <a href="{{url('search_city_property/141')}}">Ouanaminthe</a>, 
      <a href="{{url('search_city_property/144')}}">Petion-Ville</a>, 
      <a href="{{url('search_city_property/83')}}">Delmas</a>, 
      <a href="{{url('search_city_property/2')}}">Dominican Republic</a>
    </p> 
