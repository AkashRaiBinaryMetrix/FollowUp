            ...
            <table class="manage-table responsive-table">
              ...
              <tr>
                ...
                <td class="usermypro-action">
                    <a href="{{ url('view-user-property/'.$detail->id) }}" class="view"><i class="las la-eye"></i></a>
                    <a href="{{ url('edit-user-property/'.$detail->id) }}" class="edit"><i class="las la-edit"></i></a> 
                    <a href="#" class="delete" onclick="delete_property({{$detail->id}});"><i class="las la-trash-alt"></i></a>
                </td>
              </tr>
              @endforeach
