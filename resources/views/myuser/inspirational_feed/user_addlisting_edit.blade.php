...
<form class="common-form" id="signupForm" method="POST" action="{{ route('user.usereditaddlistingprocess') }}" enctype="multipart/form-data">
           ...
           <div class="useramdin-form1 whitebox">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <input {{ ($getPropById->property_for == "sell" ? "checked":"") }} class="" name="property_for" id="property_for" value="sell" type="radio"> Sell
                <input {{ ($getPropById->property_for == "rent" ? "checked":"") }} class="" name="property_for" id="property_for" value="rent" type="radio"> Rent
              </div>
            </div>
                  ...
                  <div class="five-checkbox-col">
                    ...
                    <div class="custom-control" style="margin-left: -3%;">
                      @foreach($house_rules as $rules)
                        @php
                          $get_property_houserule = DB::table('create_an_add_rules')
