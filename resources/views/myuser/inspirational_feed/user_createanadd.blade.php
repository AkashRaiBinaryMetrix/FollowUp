       ...
       <div class="col-md-9">
         <div class="useradmin-right">
           ...
           <div class="useramdin-form1 whitebox">
            <div class="useradmin-title">Create an Add</div>  
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <input class="" name="property_for" id="property_for" value="sell" type="radio"> Sell
                <input class="" name="property_for" id="property_for" value="rent" type="radio"> Rent
              </div>
            </div>
