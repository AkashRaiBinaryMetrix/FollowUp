       ...
       <div class="col-md-12">
         <div class="useradmin-right">
           <div class="useramdin-form1 whitebox">
            <div class="useradmin-title">Paypal Entry Page</div>  
            ...
            <div class="col-12">
              <div class="form-group">
               <div class="container">
                <div class="pro-box">
                <div class="body">
                    <form action="{{ route('user.userpaypalform') }}" method="post">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="mt-3 mb-2">
                            ...
                            <button type="submit" name="btnSubmit" class="common-btn">Click here to proceed for Paypal Payment Page</button>
                        </div>  
                    </form>
                    </div>
                </div>
