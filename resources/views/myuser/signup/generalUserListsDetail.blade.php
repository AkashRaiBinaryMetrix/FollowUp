...
<div class="agent-detail-sec">
 <div class="inner-agentdetail-sec">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-7">
              <div class="agentmember-content">
                <h3>{{$getDetails[0]->name}}</h3>
                <p><a href="#"><i class="las la-envelope"></i> <strong>Email:</strong> {{$getDetails[0]->email}}</a></p>
                <p>*Please contact website admin for further details</p>    
              </div>
            </div>  
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-lg-12 custom-left">
        <div class="agentdt-recentcol">
        <h3 class="pro-mid-title">Recently Visited Properties</h3>      
          ...
          <div class="row">
             ...
             <div class="col-lg-3 col-md-4 col-sm-6">
               <div class="pro-list-col">
                 <a href="#">
                 <div class="pro-listpic"><img src="https://binarymetrix-dev.com/lineon/public/images/listing-8.jpg" class="img-responsive" alt="" data-pagespeed-url-hash="2729133136" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></div>
