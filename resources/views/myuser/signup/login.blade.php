...
<div class="toast failure" data-autohide="false" style="display: none">
    ...
    <div class="toast-body"
        ...
        <div class="form-group">
            <input class="form-control" placeholder="Password" value="{{ old('password') }}" type="password" name="password" required="">
            @error('password')
        ...
        <div class="form-group mb10 cust-box">
            <div class="row">
              ...
              <div class="col-6 text-right"><a href="{{ url('/forgot-password') }}">Forgot password?</a></div>   
            </div>
        </div>  

        <div class="form-group mb-0"><button type="submit" class="common-btn">Login</button></div>
