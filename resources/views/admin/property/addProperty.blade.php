...
<style>
  ...
  .inner-bannerbar{display: none;}
</style>
<form class="common-form" id="signupForm" method="post" action="{{ route('admin.listnewpropertyprocess') }}" enctype="multipart/form-data">
@csrf
   
<div class="useradmin-pages" style="margin-top:0px !important">
 <div class="container" style="width: 1287px;margin-left: -177px;">
     <div class="row">
       <div class="col-md-9">
...
<div class="gallery"></div>
           ...
           <div class="useramdin-form1 whitebox">
            ...
            <div class="col-12 col-sm-6">
              <div class="form-group">
                <label>City</label>
                <input class="form-control" name="city" id="city" value="" placeholder="Enter City" type="text" autocomplete="off">
              </div>
            </div>
