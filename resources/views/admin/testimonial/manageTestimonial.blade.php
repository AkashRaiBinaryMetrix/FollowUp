          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <h4 class="card-title">Add Testimonial | enter details and submit</h4>
            ...
            <form action="{{ url('admin/addUpdateTestimonialPage') }}" enctype="multipart/form-data" method="post" class="forms-sample">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  <textarea type="text" class="form-control" id="" name="description" placeholder="Long Description">{{old('long_description')}}</textarea>
